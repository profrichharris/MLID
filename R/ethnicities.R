...
#' Output Areas (LLSOAs), which group into Middle Level Super Output Areas
#' (MLSOAs), which group into Local Authority Districts (LADs) and then into
...
#'    \item columns 17-20, the ID codes for the higher-level geographies:
#'    LLSOAs, MLSOAs, LADs and RGNs
#' }
#'
